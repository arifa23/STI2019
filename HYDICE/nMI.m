...
% mutual information
load PC_DC_Train.txt % loads input data
data=PC_DC_Train(:,3:end);% input starting from row 3 upto end are considered sample data 

c1 =PC_DC_Train(:,1);% first row input is cosidered as class label
...
%title('Mutual information between class label and principal component');
